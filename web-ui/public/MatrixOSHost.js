...
var _MatrixOS_Wasm_GetFrameBuffer = Module['_MatrixOS_Wasm_GetFrameBuffer'] = makeInvalidEarlyAccess('_MatrixOS_Wasm_GetFrameBuffer');
var _MatrixOS_Wasm_GetFrameBufferByteLength = Module['_MatrixOS_Wasm_GetFrameBufferByteLength'] = makeInvalidEarlyAccess('_MatrixOS_Wasm_GetFrameBufferByteLength');
var _MatrixOS_Wasm_GetWidth = Module['_MatrixOS_Wasm_GetWidth'] = makeInvalidEarlyAccess('_MatrixOS_Wasm_GetWidth');
var _MatrixOS_Wasm_GetHeight = Module['_MatrixOS_Wasm_GetHeight'] = makeInvalidEarlyAccess('_MatrixOS_Wasm_GetHeight');
var _MatrixOS_Wasm_KeyEvent = Module['_MatrixOS_Wasm_KeyEvent'] = makeInvalidEarlyAccess('_MatrixOS_Wasm_KeyEvent');
var _MatrixOS_Wasm_FnEvent = Module['_MatrixOS_Wasm_FnEvent'] = makeInvalidEarlyAccess('_MatrixOS_Wasm_FnEvent');
var _MatrixOS_Wasm_KeypadTick = Module['_MatrixOS_Wasm_KeypadTick'] = makeInvalidEarlyAccess('_MatrixOS_Wasm_KeypadTick');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['MatrixOS_Wasm_GetFrameBuffer'] != 'undefined', 'missing Wasm export: MatrixOS_Wasm_GetFrameBuffer');
  assert(typeof wasmExports['MatrixOS_Wasm_GetFrameBufferByteLength'] != 'undefined', 'missing Wasm export: MatrixOS_Wasm_GetFrameBufferByteLength');
  assert(typeof wasmExports['MatrixOS_Wasm_GetWidth'] != 'undefined', 'missing Wasm export: MatrixOS_Wasm_GetWidth');
  assert(typeof wasmExports['MatrixOS_Wasm_GetHeight'] != 'undefined', 'missing Wasm export: MatrixOS_Wasm_GetHeight');
  assert(typeof wasmExports['MatrixOS_Wasm_KeyEvent'] != 'undefined', 'missing Wasm export: MatrixOS_Wasm_KeyEvent');
  assert(typeof wasmExports['MatrixOS_Wasm_FnEvent'] != 'undefined', 'missing Wasm export: MatrixOS_Wasm_FnEvent');
  assert(typeof wasmExports['MatrixOS_Wasm_KeypadTick'] != 'undefined', 'missing Wasm export: MatrixOS_Wasm_KeypadTick');
  ...
  _MatrixOS_Wasm_GetFrameBuffer = Module['_MatrixOS_Wasm_GetFrameBuffer'] = createExportWrapper('MatrixOS_Wasm_GetFrameBuffer', 0);
  _MatrixOS_Wasm_GetFrameBufferByteLength = Module['_MatrixOS_Wasm_GetFrameBufferByteLength'] = createExportWrapper('MatrixOS_Wasm_GetFrameBufferByteLength', 0);
  _MatrixOS_Wasm_GetWidth = Module['_MatrixOS_Wasm_GetWidth'] = createExportWrapper('MatrixOS_Wasm_GetWidth', 0);
  _MatrixOS_Wasm_GetHeight = Module['_MatrixOS_Wasm_GetHeight'] = createExportWrapper('MatrixOS_Wasm_GetHeight', 0);
  _MatrixOS_Wasm_KeyEvent = Module['_MatrixOS_Wasm_KeyEvent'] = createExportWrapper('MatrixOS_Wasm_KeyEvent', 3);
  _MatrixOS_Wasm_FnEvent = Module['_MatrixOS_Wasm_FnEvent'] = createExportWrapper('MatrixOS_Wasm_FnEvent', 1);
  _MatrixOS_Wasm_KeypadTick = Module['_MatrixOS_Wasm_KeypadTick'] = createExportWrapper('MatrixOS_Wasm_KeypadTick', 0);
